let item_1 = 5 //1,2. Создать переменную “item_1” и присвоить переменной значение 5
console.log(item_1) //3. вывести в консоль переменную item_1
let item_2 = 3 //4,5. создать переменную item_2 и присвоить переменной значение 3
console.log(item_2) //6.вывыести в консоль переменную item_2
